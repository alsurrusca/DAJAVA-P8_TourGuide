...
public class UserPreferencesDTO {
    ...
    public UserPreferencesDTO(String username, int attractionProximity, String currency, int lowerPricePoint, int highPricePoint, int tripDuration, int ticketQuantity, int numberOfAdults, int numberOfChildren) {
